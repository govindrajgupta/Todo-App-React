    ...
    <>
      ...
      <h1 className='font-bold text-center text-2xl'>iTodo - Manage your todos at one place</h1>
        ...
        <div className="addtodo my-5 flex flex-col gap-4">
          ...
          <button onClick={handleAdd} disabled={todo.length<=3} className=' bg-violet-800 mx-2 rounded-full hover:bg-violet-950 disabled:bg-voilet-700 p-2 py-1 text-sm font-bold text-white '>Save</button>
          </div>
